...
def read_txt_and_tokenize(txt_path: str, bpe, target_dict):
    ...
    with open(txt_path, 'r', encoding='utf8') as fp:
        for line in fp.readlines():
            ...
            annotations.append({'bbox': bbox, 'encoded_str': encoded_str, 'category_id': 0,
                                'segmentation': [quadrangle]})  # 0 for text, 1 for background
...
def SROIETask2(root_dir: str, bpe, target_dict, crop_img_output_dir=None):
    ...
    for jpg_path in tqdm(image_paths):
        ...
        img_dict = {'file_name': jpg_path, 'width': img_w, 'height': img_h, 'image_id': img_id,
        ...
        for ann in annotations:
            ...
            crop_img_dict = {'img': crop_im, 'file_name': jpg_path, 'width': crop_w, 'height': crop_h,
                             'image_id': crop_img_id, 'encoded_str': ann['encoded_str']}
